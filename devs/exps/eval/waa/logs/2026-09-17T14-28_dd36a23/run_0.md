...
|---|---:|---:|---:|---:|---:|---:|---:|
| GPT-5.6 Sol xhigh | 138/138 | 0.716036 | 71.6036% | 11.99 | 21,622,194 | 252,940 | 0 |
| GPT-5.6 Sol Medium | 138/138 | 0.700250 | 70.0250% | 11.08 | 18,106,995 | 150,777 | 0 |
| GPT-5.5 Medium | 138/138 | 0.665688 | 66.5688% | 13.28 | 24,837,106 | 257,356 | 0 |
| GPT-5.6 Sol none | 138/138 | 0.506998 | 50.6998% | 8.42 | 10,040,383 | 64,292 | 0 |
...
| ⚠️ GPT-6 Astra Medium | _**137/138**_ | _**0.634359**_ | 62.9762% | 8.09 | 9,960,740 | 80,371 | 1 |
...
- GPT-5.6 Sol xhigh scores 71.60%; UI-Venus-2-9B leads the local models at 41.28%.
...
|---|---|---|---|
| GPT-5.5 / GPT-5.6 Sol / GPT-6 Astra Medium | [gpt/waa.yaml](/scripts/configs/gpt/default/waa.yaml) | Medium; 4096 output tokens | Chained Responses history |
| GPT-5.6 Sol none | [gpt/waa.none.yaml](/scripts/configs/gpt/default/waa.none.yaml) | None; 4096 output tokens | Chained Responses history |
| GPT-5.6 Sol xhigh | [gpt/waa.xhigh.yaml](/scripts/configs/gpt/default/waa.xhigh.yaml) | xhigh; 4096 output tokens | Chained Responses history |
...
decoding does not use top-p. The none/xhigh YAMLs differ from the GPT default
...
./devs/exps/eval/waa/run.sh gpt-5.6-sol scripts/configs/gpt/default/waa.xhigh.yaml
```
