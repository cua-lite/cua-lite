...
- **Commit**: `5268092` - AndroidLab reference models.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| GPT-5.5 | 138/138 | 0.615942 | 61.5942% | 8.15 | 12,325,852 | 78,437 | 0 |
| GPT-5.6 Sol | 138/138 | 0.608696 | 60.8696% | 7.96 | 11,579,574 | 59,231 | 0 |
| GPT-6 Astra | 138/138 | 0.608696 | 60.8696% | 7.10 | 8,831,343 | 27,465 | 0 |
...
- GPT-5.5 scores 61.59%; Qwen3.8-27B and UI-Venus-2-9B each score 37.68%.

## Experiment Specification

| Model | YAML | Sampling | History |
|---|---|---|---|
| GPT-5.5 / GPT-5.6 Sol / GPT-6 Astra | [gpt/androidlab.yaml](/scripts/configs/gpt/default/androidlab.yaml) | Medium; 4096 output tokens | Chained Responses history |
