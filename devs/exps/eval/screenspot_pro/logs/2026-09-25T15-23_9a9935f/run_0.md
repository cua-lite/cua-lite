# screenspot_pro @ 2026-09-25T15-23_9a9935f - run_0

- **Commit**: `9a9935f` - Official non-thinking UI-Venus grounding defaults.
- **Host / GPUs**: `gpublaze` / NVIDIA H100 80 GB.
- **Artifacts**: `.exps/eval/screenspot_pro/2026-09-25T15-23_9a9935f/run_0/` (gitignored).
- **Started**: `2026-09-25 PDT`.
- **Last updated**: `2026-09-25 16:26 PDT`.
- **Notes**: `eval`, 1581 tasks; 12 concurrent Venus grounding tasks.
- **Provenance**: [JSON snapshot](/devs/exps/eval/screenspot_pro/logs/2026-09-25T15-23_9a9935f/run_0.json) records per-model source paths, configurations and hashes. Fresh non-thinking UI-Venus run; other model results retain their recorded sources.
...
| `inclusionAI/UI-Venus-2-9B` | default | 1581/1581 | 0.719165 |
...
| UI-Venus-2-9B | [ui_venus_2/screenspot_pro.yaml](/scripts/configs/ui_venus_2/default/screenspot_pro.yaml) | Non-thinking; temperature 0; 1024 output tokens |
...
| `inclusionAI/UI-Venus-2-9B` | 0.7050 | 0.6569 | 0.7425 | 0.6990 | 0.8435 | 0.6929 | 0.7192 |
...
| `inclusionAI/UI-Venus-2-9B` | 0.5546 | 0.8209 | 0.7192 |
