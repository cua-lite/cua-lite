...
from lite.gym.utils.backend.ports import allocate_ports, release_ports
...
class QemuInstance:
    ...
    def __init__(
        ...
        *,
        ...
        self._reserved_ports: tuple[int, ...] = ()
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            async with docker_create_slot_async():
                ...
                self._reserved_ports = (bridge_port, novnc_port)
                run_args = [
    ...
    async def close(self) -> None:
        ...
        if name:
            ...
            if code != 0 and "no such container" not in detail.lower():
                ...
                return
        if self._reserved_ports:
            release_ports(*self._reserved_ports)
